  ...
  <tr> 
    <td> 
      <form action="<? echo $formtarget;?>" method="POST" target="skpage" enctype="multipart/form-data" name="editform" onSubmit="_close()">
        ...
        <input type="Hidden" name="type" value="phpfile">
        ...
        <tr> 
            <td width="35%"><b>PHP-Script-Datei</b><br>
            Mit relativen Pfad zum Server-Root angeben<br> (z.B. "sk/modules/mymod/myphpfile.php")
              </td>
            <td width="65%">
              <input type="text" name="attributes_vars[filename]" size="40" value ="<? echo $edit_object->attributes_vars[filename];?>">
