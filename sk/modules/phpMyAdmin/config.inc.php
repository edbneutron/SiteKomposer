 ...
 */
$cfg['PmaAbsoluteUri'] = SK_URL.'modules/phpMyAdmin/';
...
$cfg['Servers'][$i]['user']          = $db_admin_name;      // MySQL user
$cfg['Servers'][$i]['password']      = $db_admin_pw;          // MySQL password (only needed
                                                    // with 'config' auth_type)
$cfg['Servers'][$i]['only_db']       = $dbname;          // If set to a db-name, only
