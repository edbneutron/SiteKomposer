...
v_bgColor='#fff5c6';//set [='transparent'] for transparent
v_top=100;//	|
v_left=20;//	| defining
v_width=88;//	| the box
v_height=31;//	|
...
v_content=[
['javascript:;','<img src=ban1.gif width=88 height=31 border=0>','_self'],
['javascript:;','<img src=ban2.gif width=88 height=31 border=0>','_self'],
['javascript:;','<img src=ban3.gif width=88 height=31 border=0>','_self']
];
