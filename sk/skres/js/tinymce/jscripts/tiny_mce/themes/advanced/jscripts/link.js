...
function init() {
	...
	selectByValue(formObj, 'relSelect', tinyMCE.getWindowArg('rel'), true);
...
function insertLink() {
	...
	var rel = document.forms[0].relSelect.value;
	...
	tinyMCE.themes['advanced']._insertLink(href, target, title, dummy, style_class,rel);
	tinyMCEPopup.close();
}
